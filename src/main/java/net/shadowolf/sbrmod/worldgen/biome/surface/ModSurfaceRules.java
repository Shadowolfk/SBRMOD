package net.shadowolf.sbrmod.worldgen.biome.surface;
...
public class ModSurfaceRules {
    private static final SurfaceRules.RuleSource DEVILS_PALM_SAND = makeStateRule(ModBlocks.DEVILS_SAND.get());
